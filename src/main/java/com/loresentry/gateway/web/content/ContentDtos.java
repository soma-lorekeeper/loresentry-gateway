...
public final class ContentDtos {
    ...
    public record Snapshot(String title, @JsonProperty("body_md") String bodyMd, List<TextProperty> properties, List<Relation> relations) {
        ...
        public ContentData.Snapshot internal() { return new ContentData.Snapshot(title, bodyMd, properties == null ? null : properties.stream().map(v -> v == null ? null : v.internal()).toList(), relations == null ? null : relations.stream().map(v -> v == null ? null : v.internal()).toList()); }
    }
    @JsonInclude(JsonInclude.Include.ALWAYS)
    public record Content(UUID id, @JsonProperty("project_id") UUID projectId, String title, @JsonProperty("folder_code") String folderCode, @JsonProperty("episode_id") UUID episodeId, @JsonProperty("body_md") String bodyMd, List<TextProperty> properties, List<Relation> relations, Boolean locked, @JsonProperty("char_count") Integer charCount, @JsonProperty("revision_no") Long revisionNo, @JsonProperty("updated_at") OffsetDateTime updatedAt) {
        ...
        public ContentData.Content internal() { return new ContentData.Content(id, projectId, title, folderCode, episodeId, bodyMd, properties == null ? null : properties.stream().map(v -> v == null ? null : v.internal()).toList(), relations == null ? null : relations.stream().map(v -> v == null ? null : v.internal()).toList(), locked, charCount, revisionNo, updatedAt); }
    }
    @JsonInclude(JsonInclude.Include.ALWAYS)
